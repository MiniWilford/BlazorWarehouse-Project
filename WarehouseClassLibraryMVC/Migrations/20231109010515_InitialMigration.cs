    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Managers",
                columns: new[] { "ManagerId", "EmployeeId", "FirstName", "LastName", "Title" },
                values: new object[,]
                {
                    { 1, null, "Kyle", "DeJarnett", "Owner" },
                    { 2, null, "Justin", "Smith", "Assistant Manager" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Pepperoni Pizza", 12.99f },
                    { 3, "Bread Sticks", 4.99f },
                    { 4, "Salad", 2.99f }
                });
